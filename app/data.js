...
const DAYS = [
  ...
  { day: 5, title: 'Web App Architecture', tag: '3-tier model, sessions, cookie flags', lesson: 'day-05-architecture-interactive.html', note: 'day-05-revision-notes.md', phase: 'foundations' },
  { day: 6, title: 'OWASP Top 10', tag: 'Museum exhibit hall, all 10 ranks', lesson: 'day-06-owasp-interactive.html', note: 'day-06-revision-notes.md', phase: 'foundations' },
  { day: 7, title: 'Burp Suite Deep Dive', tag: 'Live repeater + decoder simulator', lesson: 'day-07-burpsuite-interactive.html', note: 'day-07-revision-notes.md', phase: 'foundations' },
  { day: 8, title: 'SQL Injection Mastery', tag: 'Live breach simulator, matrix terminal', lesson: 'day-08-sqli-interactive.html', note: 'day-08-revision-notes.md', phase: 'foundations' },
  { day: 9, title: 'XSS', tag: 'Reflected, stored, DOM — injection lab', lesson: 'day-09-xss-interactive.html', note: 'day-09-revision-notes.md', phase: 'foundations' },
...
const NOTES = [
  ...
  { id: 'day-05', title: 'Day 5 — Web App Architecture', desc: '3-tier model, auth vs authz, session flow, cookie flags', file: 'day-05-revision-notes.md' },
  { id: 'day-06', title: 'Day 6 — OWASP Top 10', desc: 'All 10 ranks in depth, mnemonic, self-test', file: 'day-06-revision-notes.md' },
  { id: 'day-07', title: 'Day 7 — Burp Suite Deep Dive', desc: 'Interception chain, tab reference, workflow, shortcuts', file: 'day-07-revision-notes.md' },
  { id: 'day-08', title: 'Day 8 — SQL Injection', desc: 'Five injection types, payload anatomy, parameterized query fix', file: 'day-08-revision-notes.md' },
  { id: 'day-09', title: 'Day 9 — XSS', desc: 'Reflected/stored/DOM strains, payload anatomy, encoding + CSP + HttpOnly', file: 'day-09-revision-notes.md' },
  { id: 'day-10-25', title: 'Days 10–25 — AppSec Core', desc: 'Phase 1 review, Auth, IDOR, CSRF, SSRF, JWT, Secure Coding, Threat Modeling, Crypto, DevSecOps', file: 'days-05-25-revision-notes.md' },
